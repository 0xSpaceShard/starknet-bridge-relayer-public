...
export interface StarknetOperatorInterface extends utils.Interface {
  functions: {
...
export interface StarknetOperator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StarknetOperatorInterface;
